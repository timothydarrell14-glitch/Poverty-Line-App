...
from app.schemas.donation_schema import donation_schema, donations_schema, donation_create_schema
...
def get_program_donation_total(program_id):
	...
	return jsonify({"program_id": program_id, "total_donations": float(total or 0)}), 200