  ...
  const submitAccount = async (event) => {
    ...
    try {
      if (isSignUp) {
        ...
        if (!signup.ok) { if (signup.status === 409) { setAccountMode("signin"); throw Error("This email already has an account. Please sign in with your password."); } throw Error(errorMessage(signupData, "We could not create your account.")); }
      }
      ...
      if (!login.ok || !loginData.access_token) throw Error(errorMessage(loginData, "We could not sign you in."));
